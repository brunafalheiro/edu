<template>
  <div class="w-full min-h-[220px] flex items-end justify-end bg-lavender-ultralight/40 p-6 relative overflow-hidden">
    <img src="@/assets/images/edu.png" class="absolute h-72 -top-7 -left-4 object-contain">
