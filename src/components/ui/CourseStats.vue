<template>
  <div class="w-full min-h-[180px] flex items-end justify-end rounded-lg bg-lavender-ultralight/40 border border-black relative p-6 mb-12 position-relative overflow-hidden">
    ...
    <div class="w-full flex flex-wrap justify-end gap-4">
      <div class="h-24 w-full max-w-min bg-white border border-black rounded-lg flex items-center justify-between p-6 shadow-[6px_6px_0_0_#000] cursor-default transition-transform duration-200 hover:scale-105 hover:shadow-[8px_8px_0_0_#000]">
      ...
      <div class="h-24 w-full max-w-min min-w-48 bg-white border border-black rounded-lg flex items-center justify-between p-6 shadow-[6px_6px_0_0_#000] cursor-default transition-transform duration-200 hover:scale-105 hover:shadow-[8px_8px_0_0_#000]">
