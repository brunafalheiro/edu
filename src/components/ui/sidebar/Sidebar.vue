        ...
        <AccordionTrigger class="text-left">
          <div class="flex items-center mr-2">
            <div
              ...
              class="bg-lavender min-w-12 min-h-12 rounded-full flex items-center justify-center mr-4"
            >
            ...
            <div v-else class="relative max-w-12 max-h-12 w-full h-full mr-4">
              <svg class="w-full h-full" viewBox="0 0 36 36">
                ...
                <!-- Progress circle -->
                <circle
                  class="text-lavender stroke-current transition-all duration-700 ease-in-out"
                  stroke-width="3"
